...
int main()
{
    ...
    print_matrix("m1_tr", m1_tr, ROWS1, COLS1);
    print_matrix("m2_tr", m2_tr, ROWS2, COLS2);
    print_matrix("m3_tr", m3_tr, ROWS3, COLS3);
    print_matrix("m4_tr", m4_tr, ROWS4, COLS4);
    print_matrix("m5_tr", m5_tr, ROWS5, COLS5);
